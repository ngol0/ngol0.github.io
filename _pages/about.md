...
I am currently a Visiting Researcher & AI/ML Engineer at [CitAI Research Center](https://cit-ai.net/) in London. I am collaborating with PhD student [Vasilis Siomos](https://www.citystgeorges.ac.uk/about/people/research-students/vasilis-siomos) and [Dr. Giacomo Tarroni](https://www.citystgeorges.ac.uk/about/people/academics/giacomo-tarroni) on a project investigating image partitioning methods such as agentic workflow to tackle non-IID data problem in federated learning for medical image analysis tasks.

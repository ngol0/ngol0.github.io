...
I am currently collaborating with [Dr. Jiancheng (JC) Yang](https://jiancheng-yang.com/) at Aalto University. I am working on developing methods for 3D surface reconstruction of cardiac structures via diffusion posterior sampling & geometric distribution learning. In addition, I have been collaborating with [Dr. Giacomo Tarroni](https://www.citystgeorges.ac.uk/about/people/academics/giacomo-tarroni) at [CitAI Research Center](https://cit-ai.net/) on developing VLM-guided dataset partitioning methods to address the scarcity of real-world federated datasets in computer vision.

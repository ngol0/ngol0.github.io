    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          title: 'I gave a presentation at ISNN 2025 :sparkles: :smile:',
          description: "",
          ...
          description: "",
          section: "News",},{id: "news-our-federated-simulation-dataset-paper-second-author-was-accepted-to-neurips-2026-evaluations-and-datasets-track",
          title: 'Our Federated Simulation Dataset paper (second author) was accepted to NeurIPS 2026 Evaluations...',
          description: "",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/raytracing/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/ngol0", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=YHQq6bEAAAAJ&hl", "_blank");
        },
      },{
      id: 'light-theme',
